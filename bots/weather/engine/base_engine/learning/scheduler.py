...
from bots.weather.engine.base_engine.data.database_lock import acquire_lock, LockAcquisitionError
    ...
    async def _loop(self) -> None:
        ...
        while self.running:
            try:
                ...
                try:
                    from bots.weather.engine.base_engine.monitoring.error_tracking import get_error_tracker
