...
class LearningEngine:
    ...
    async def save_patterns_to_db(self) -> None:
        ...
        from bots.weather.engine.base_engine.data.database import LearningPattern
        async with self.db.get_session() as session:
    ...
    async def get_bet_type_confidence(
        ...
        import numpy as np
        from bots.weather.engine.base_engine.utils.validation import validate_price
    ...
    async def update_simulation_confidence(
        ...
        from bots.weather.engine.base_engine.utils.validation import validate_numeric
