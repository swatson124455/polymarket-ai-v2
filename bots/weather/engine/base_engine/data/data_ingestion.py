...
from bots.weather.engine.base_engine.data.recovery_hierarchy import RecoveryHierarchy, RecoveryLevel
...
from bots.weather.engine.base_engine.exceptions import (
    DataIngestionError,
    MarketFetchError,
    PriceFetchError,
    DatabaseError,
...
class DataIngestionService:
    ...
    async def run_resolution_backfill(self, *, log_progress: bool = True, **kwargs) -> Dict[str, Any]:
        ...
        from bots.weather.engine.base_engine.data.resolution_backfill import run_resolution_backfill
                ...
                for trader_address in trader_addresses:
                    try:
                        ...
                        if trade_data and self.db.session_factory:
                            from bots.weather.engine.base_engine.data.id_resolver import resolve_market_ids_batch
