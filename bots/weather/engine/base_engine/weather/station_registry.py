...
STATION_REGISTRY: Dict[str, WeatherStation] = {
    ...
    "dallas": WeatherStation(
        ...
        temp_unit="F",
        aliases=("dallas",),
        resolution_source="Weather Underground / KDAL (Love Field — per Polymarket market description)",
        has_asos_1min=True,
    ),
    ...
    "denver": WeatherStation(
        ...
        temp_unit="F",
        aliases=("denver",),
        resolution_source="Weather Underground / KBKF (Buckley SFB — per Polymarket market description)",
        has_asos_1min=False,
    ),
    ...
    "houston": WeatherStation(
        ...
        temp_unit="F",
        aliases=("houston",),
        resolution_source="Weather Underground / KHOU (Hobby — per Polymarket market description)",
        has_asos_1min=True,
    ),
    ...
    "seoul": WeatherStation(
        ...
        temp_unit="C",
        aliases=("seoul",),
        resolution_source="Weather Underground / RKSI (Incheon Intl — per Polymarket market description)",
    ...
    # ⚠ S231 INPUT AUDIT (2026-07-17): Polymarket resolves Hong Kong on the
    # HK OBSERVATORY "Absolute Daily Max" (urban HQ station), NOT the airport
    # METAR below. A WU/ICAO swap cannot express that — needs an HKO
    # open-data truth integration (S233). Until then HK forecasts/truth are
    # KNOWINGLY mis-stationed; treat HK reads as unreliable.
    ...
    "taipei": WeatherStation(
        ...
        temp_unit="C",
        aliases=("taipei",),
        resolution_source="Weather Underground / RCSS (Taipei Songshan — per Polymarket market description)",
    ),
    ...
    "istanbul": WeatherStation(
        ...
        temp_unit="C",
        aliases=("istanbul",),
        resolution_source="NOAA / LTFM (Istanbul Airport — per Polymarket market description)",
    ),
    ...
    "milan": WeatherStation(
        ...
        resolution_source="Weather Underground / LIMC (Malpensa — per Polymarket market description)",
        local_model="meteofrance_seamless",
    ),
