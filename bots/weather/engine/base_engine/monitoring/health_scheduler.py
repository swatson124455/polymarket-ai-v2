...
class HealthScheduler:
    ...
    # _run_daily_audit removed — now runs via systemd timer (polymarket-audit.timer, daily 03:00 UTC)
    ...
    def start(self) -> None:
        ...
        from bots.weather.engine.config.settings import settings as _cfg
        ...
        jobs = [
            ...
            # daily_audit removed — now runs via systemd timer (polymarket-audit.timer, daily 03:00 UTC)
        ]
