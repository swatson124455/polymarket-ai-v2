...
from bots.weather.engine.base_engine.ml.rlvr.training_config import RLVRTrainingConfig, brier_score_reward
...
def train_rlvr(
    ...
    try:
        ...
        def reward_fn(predictions: List[str], references: List[str]) -> List[float]:
            ...
            from bots.weather.engine.base_engine.ml.rlvr.inference import _extract_probability
            rewards = []
