...
from bots.weather.engine.base_engine.data.data_ingestion import DataIngestionService
from bots.weather.engine.base_engine.data.ingestion_scheduler import IngestionScheduler
from bots.weather.engine.base_engine.data.unified_market_service import UnifiedMarketService
from bots.weather.engine.base_engine.backtesting.backtest_engine import BacktestEngine
from bots.weather.engine.base_engine.learning.learning_engine import LearningEngine
from bots.weather.engine.base_engine.learning.simulation_engine import SimulationEngine
from bots.weather.engine.base_engine.prediction.prediction_engine import PredictionEngine
...
from bots.weather.engine.base_engine.monitoring.alerting import AlertingSystem
from bots.weather.engine.base_engine.monitoring.metrics_dashboard import MetricsDashboard
from bots.weather.engine.base_engine.monitoring.data_quality import DataQualityMonitor
from bots.weather.engine.base_engine.monitoring.recovery import RecoveryProcedure
from bots.weather.engine.base_engine.monitoring.backup_recovery import BackupManager

# New analysis systems
from bots.weather.engine.base_engine.analysis.market_regime import MarketRegimeDetector
from bots.weather.engine.base_engine.analysis.multi_timeframe import MultiTimeframeAnalyzer
from bots.weather.engine.base_engine.analysis.correlation_strategies import CorrelationStrategy
from bots.weather.engine.base_engine.analysis.order_flow import OrderFlowAnalyzer

# New portfolio systems
from bots.weather.engine.base_engine.portfolio.portfolio_rebalancer import PortfolioRebalancer

# New risk systems
from bots.weather.engine.base_engine.risk.dynamic_position_sizing import DynamicPositionSizing

# New execution systems
from bots.weather.engine.base_engine.execution.advanced_orders import AdvancedOrderManager
from bots.weather.engine.base_engine.execution.position_manager import AutomatedPositionManager

# New signal and data systems
from bots.weather.engine.base_engine.signals.signal_ingestion import SignalIngestionService
from bots.weather.engine.base_engine.signals.whale_tracker import WhaleTracker
from bots.weather.engine.base_engine.learning.performance_tracker import PerformanceTracker
from bots.weather.engine.base_engine.data.websocket_manager import WebSocketManager

# New risk and analysis systems
from bots.weather.engine.base_engine.risk.drawdown_controller import DrawdownController
from bots.weather.engine.base_engine.data.orderbook_tracker import OrderBookTracker
from bots.weather.engine.base_engine.data.trade_flow_analyzer import TradeFlowAnalyzer

# New roadmap implementations
from bots.weather.engine.base_engine.analysis.resolution_risk import ResolutionRiskAnalyzer
from bots.weather.engine.base_engine.execution.smart_order_router import SmartOrderRouter
from bots.weather.engine.base_engine.risk.liquidity_guardian import LiquidityGuardian
from bots.weather.engine.base_engine.execution.order_management_system import OrderManagementSystem
from bots.weather.engine.base_engine.signals.copy_trading_engine import CopyTradingEngine
from bots.weather.engine.base_engine.learning.wallet_clustering import WalletClustering
from bots.weather.engine.base_engine.analysis.performance_attribution import PerformanceAttribution
from bots.weather.engine.base_engine.analysis.trade_journal import TradeJournal
from bots.weather.engine.base_engine.monitoring.report_generator import ReportGenerator
from bots.weather.engine.base_engine.data.market_metadata_enricher import MarketMetadataEnricher
from bots.weather.engine.base_engine.signals.google_trends import GoogleTrendsClient
from bots.weather.engine.base_engine.signals.signal_effectiveness import SignalEffectivenessTracker

# Lower priority implementations
from bots.weather.engine.base_engine.data.historical_data_warehouse import HistoricalDataWarehouse
from bots.weather.engine.base_engine.execution.paper_trading import PaperTradingEngine
from bots.weather.engine.base_engine.learning.ab_testing import ABTestingFramework
from bots.weather.engine.base_engine.data.mempool_monitor import MempoolMonitor

# Coordination and lifecycle (mandatory for multi-bot)
from bots.weather.engine.base_engine.coordination import KillSwitch, TradeCoordinator
from bots.weather.engine.base_engine.monitoring.dead_man_switch import DeadManSwitch
from bots.weather.engine.base_engine.learning.scheduler import LearningScheduler
from bots.weather.engine.base_engine.learning.elite_detector import EliteUserDetector
from bots.weather.engine.base_engine.learning.calibration_tracker import CalibrationTracker
from bots.weather.engine.base_engine.learning.incremental_learning import IncrementalLearner
from bots.weather.engine.base_engine.learning.meta_learning import MetaLearner
from bots.weather.engine.base_engine.learning.causal_inference import CausalInferenceEngine
from bots.weather.engine.base_engine.learning.feature_store import FeatureStore
from bots.weather.engine.base_engine.monitoring.error_tracking import ErrorTracker, init_error_tracking
from bots.weather.engine.base_engine.learning.model_versioning import ModelVersionManager
from bots.weather.engine.base_engine.sentiment.sentiment_analyzer import SentimentAnalyzer
from bots.weather.engine.base_engine.monitoring.metrics_collector import metrics_collector as _metrics_singleton
from bots.weather.engine.base_engine.monitoring.distributed_tracing import DistributedTracer, get_tracer
from bots.weather.engine.base_engine.monitoring.quality_metrics import QualityMetrics
from bots.weather.engine.base_engine.monitoring.snapshot import SnapshotManager
from bots.weather.engine.base_engine.monitoring.pipeline_gate import PipelineGate
from bots.weather.engine.base_engine.lifecycle import LifecycleManager
from bots.weather.engine.base_engine.execution.order_gateway import OrderGateway
from bots.weather.engine.base_engine.execution.rl_trade_timing import RLTradeTimingAgent

# Elevation Plan additions
from bots.weather.engine.base_engine.coordination.multi_kill_switch import MultiLayerKillSwitch
from bots.weather.engine.base_engine.risk.correlation_risk import CorrelationRiskManager
from bots.weather.engine.base_engine.config.tunable_config import TunableConfigStore
from bots.weather.engine.base_engine.learning.config_tuner import ConfigTuner
from bots.weather.engine.base_engine.features.market_impact import MarketImpactEstimator

# Elite Model Deep Dive — new signal sources + analysis
from bots.weather.engine.base_engine.signals.legislative_tracker import LegislativeTracker
from bots.weather.engine.base_engine.signals.polling_client import PollingClient
from bots.weather.engine.base_engine.signals.court_monitor import CourtMonitor
from bots.weather.engine.base_engine.signals.intl_elections import InternationalElectionsClient
from bots.weather.engine.base_engine.analysis.logical_arbitrage import LogicalArbitrageDetector
from bots.weather.engine.base_engine.analysis.bayesian_model import BayesianPollingModel
from bots.weather.engine.base_engine.features.spread_decomposition import SpreadDecomposer
from bots.weather.engine.base_engine.features.counterparty_classifier import CounterpartyClassifier
from bots.weather.engine.base_engine.portfolio.reconciliation import PositionReconciler
from bots.weather.engine.base_engine.data.tax_logger import TaxLogger
from bots.weather.engine.base_engine.data.oracle_monitor import OracleMonitor
from bots.weather.engine.base_engine.data.kalshi_client import KalshiClient
from bots.weather.engine.base_engine.config.secret_manager import SecretManager
...
from bots.weather.engine.base_engine.monitoring.streaming_anomaly import StreamingAnomalyDetector
from bots.weather.engine.base_engine.monitoring.log_miner import LogTemplateMiner
from bots.weather.engine.base_engine.monitoring.portfolio_drawdown import PortfolioDrawdownBreaker
from bots.weather.engine.base_engine.monitoring.degradation_manager import DegradationManager
from bots.weather.engine.base_engine.monitoring.health_scheduler import HealthScheduler

# 2026 Alpha Roadmap additions
from bots.weather.engine.base_engine.exchanges.arb_scanner import ArbScanner
from bots.weather.engine.base_engine.exchanges.capital_tracker import CapitalTracker
from bots.weather.engine.base_engine.features.calibration import DomainCalibrator
from bots.weather.engine.base_engine.features.agentic_rag import AgenticRAG
from bots.weather.engine.base_engine.data.sports_client import SportsClient
from bots.weather.engine.base_engine.data.contract_change_monitor import ContractChangeMonitor
from bots.weather.engine.base_engine.monitoring.airdrop_tracker import AirdropTracker
from bots.weather.engine.base_engine.monitoring.regulatory_monitor import RegulatoryMonitor
from bots.weather.engine.base_engine.analysis.wash_trading_detector import WashTradingDetector
...
class BaseEngine:
    ...
    async def init(
        ...
        try:
            from bots.weather.engine.base_engine.data.smart_fetcher import SmartDataFetcher
            ...
            from bots.weather.engine.base_engine.data.thegraph_client import TheGraphClient
            ...
            from bots.weather.engine.base_engine.monitoring.gap_detector import GapDetector
            from bots.weather.engine.base_engine.monitoring.auto_healer import AutoHealer
            ...
            if self.event_bus is None:
                try:
                    from bots.weather.engine.base_engine.coordination.event_bus import EventBus, EventSourcingBus
            ...
            if self.db and self.db.session_factory:
                try:
                    from bots.weather.engine.base_engine.data.streaming_persister import StreamingPersister
            ...
            if getattr(settings, "USER_ORDER_WS_ENABLED", False) and self.event_bus and getattr(settings, "CLOB_API_KEY", None) and getattr(settings, "CLOB_SECRET", None):
                try:
                    from bots.weather.engine.base_engine.data.user_order_websocket import UserOrderWebSocket
            ...
            if not getattr(settings, "SIMULATION_MODE", True) and os.getenv("WALLET_ADDRESS"):
                try:
                    from bots.weather.engine.base_engine.data.blockchain_client import BlockchainClient
            ...
            try:
                from bots.weather.engine.base_engine.data.webhook_dispatcher import WebhookDispatcher
                from bots.weather.engine.base_engine.integrations.arbitrage_detector import ArbitrageDetector
                from bots.weather.engine.base_engine.data.resolution_listener import ResolutionListener
                from bots.weather.engine.base_engine.monitoring.anomaly_detector import AnomalyDetector
            ...
            try:
                from bots.weather.engine.base_engine.data.lineage_tracker import LineageTracker
                from bots.weather.engine.base_engine.portfolio.portfolio_optimizer import PortfolioOptimizer
                from bots.weather.engine.base_engine.risk.risk_analytics import RiskAnalytics
                from bots.weather.engine.base_engine.monitoring.compliance_reporter import ComplianceReporter
                from bots.weather.engine.base_engine.monitoring.data_quality_sla import DataQualitySLA
                from bots.weather.engine.base_engine.analysis.market_clustering import MarketClustering
                from bots.weather.engine.base_engine.backtesting.replay_engine import ReplayEngine
            ...
            try:
                from bots.weather.engine.base_engine.exchanges.polymarket_adapter import PolymarketAdapter
                from bots.weather.engine.base_engine.exchanges.kalshi_adapter import KalshiAdapter
                from bots.weather.engine.base_engine.exchanges.coinbase_adapter import CoinbaseAdapter
                from bots.weather.engine.base_engine.exchanges.forecastex_adapter import ForecastExAdapter
        ...
        if self.db is not None:
            ...
            if self.db is not None:
                try:
                    from bots.weather.engine.base_engine.analysis.game_theory import AdverseSelectionTracker
            ...
            from bots.weather.engine.base_engine.analysis.game_theory import OrderBookAnalyzer, SmartOrderPlacer, CascadeDetector
    ...
    async def start(self):
        ...
        if not getattr(settings, "SIMULATION_MODE", True):
            from bots.weather.engine.base_engine.execution.clob_adapter import check_matic_balance as _check_matic
        ...
        if getattr(settings, "UMA_PROPOSAL_MONITOR_ENABLED", False) and self.event_bus and getattr(settings, "UMA_OO_V3_POLYGON", None):
            try:
                from bots.weather.engine.base_engine.data.blockchain_client import BlockchainClient
                from bots.weather.engine.base_engine.data.uma_proposal_monitor import run_uma_proposal_monitor
        ...
        if self.resolution_listener and self.event_bus:
            try:
                async def _on_resolution(payload):
                    ...
                    # Immediately backfill prediction_log, paper_trades, mirror_rejected_signals (S172 7B Phase A3),
                    # and trade_events RESOLUTION rows (S195).
                    try:
                        ...
                        n4 = await self.db.backfill_trade_events_resolution()
                        if n1 or n2 or n3 or n4:
                            logger.info(
                                "Resolution event: backfilled %d prediction_log + %d paper_trades + %d mirror_rejected_signals + %d trade_events_resolution",
                                n1, n2, n3, n4,
                            )
                    except Exception as _e:
    ...
    async def _fetch_tradeable_markets(self, min_liquidity, categories, _now):
        ...
        try:
            ...
            if self.unified_market_service and hasattr(self.unified_market_service, "_get_from_l3_cache"):
                # Batch fetch from DB
                async with self.db.get_session() as session:
                    from bots.weather.engine.base_engine.data.database import Market as MarketModel
