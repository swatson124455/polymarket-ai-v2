...
from bots.weather.engine.base_engine.data.database import Database, Signal
...
from bots.weather.engine.base_engine.signals.news_sources import NewsAggregator
from bots.weather.engine.base_engine.signals.social_sources import SocialAggregator
from bots.weather.engine.base_engine.signals.event_calendar import EventCalendar
from bots.weather.engine.base_engine.signals.llm_signal_extractor import LLMSignalExtractor
from bots.weather.engine.base_engine.signals.wikipedia_pageviews import WikipediaPageviews
from bots.weather.engine.base_engine.signals.entity_extractor import EntityExtractor
from bots.weather.engine.base_engine.signals.gdelt_client import GDELTClient
from bots.weather.engine.base_engine.signals.hackernews import HackerNewsClient
from bots.weather.engine.base_engine.signals.spike_detector import SpikeDetector
from bots.weather.engine.base_engine.signals.velocity_engine import VelocityEngine
from bots.weather.engine.base_engine.signals.sentiment_velocity import SentimentVelocityTracker
from bots.weather.engine.base_engine.signals.fourchan_poller import FourChanPoller
...
class SignalIngestionService:
    ...
    async def _reddit_stream_task(self):
        ...
        while self.running:
            try:
                from bots.weather.engine.base_engine.signals.social_sources import PRAWStreamClient
    ...
    async def _telegram_stream_task(self):
        ...
        while self.running:
            try:
                from bots.weather.engine.base_engine.signals.telegram_stream import TelegramStreamClient
    ...
    async def _discord_stream_task(self):
        ...
        while self.running:
            try:
                from bots.weather.engine.base_engine.signals.discord_stream import DiscordStreamClient
    ...
    async def get_signals_for_market(
        ...
        if not signals and self.db.session_factory:
            async with self.db.get_session() as session:
                ...
                from bots.weather.engine.base_engine.data.database import Signal
