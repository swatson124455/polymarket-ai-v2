...
def _get_sync_client():
    ...
    from bots.weather.engine.base_engine.execution.clob_adapter import _get_clob_client
...
class AsyncClobClient:
    ...
    async def get_order_book(self, token_id: str) -> Dict[str, Any]:
        ...
        from bots.weather.engine.base_engine.execution.clob_adapter import _get_order_book_sync
        loop = asyncio.get_running_loop()
