    ...
    async def place_order(
        ...
        if self._orderbook_tracker and token_id:
            try:
                ...
                if _book and not _book.get("error"):
                    ...
                    if _is_buy:
                        # BUY: walk ask side
                        from bots.weather.engine.base_engine.execution.paper_trading import _vwap_from_book
                        ...
                        from bots.weather.engine.base_engine.execution.paper_trading import _vwap_from_bids
        ...
        if getattr(settings, "SIMULATION_MODE", False) and self.paper_trading_engine and self.paper_trading_engine.enabled:
            ...
            try:
                ...
                try:
                    from bots.weather.engine.base_engine.monitoring.metrics_collector import metrics_collector, ORDER_PIPELINE_LATENCY
