"""
Esports Bankroll Manager — Kelly sizing + hard caps.
...
Formula:
  ...
  4. Apply per-bet cap: min(kelly_bet, ESPORTS_MAX_BET_USD)
  5. Check daily spent via OrderGateway._daily_exposure_usd
  6. Apply daily cap: min(capped_bet, max(0, ESPORTS_MAX_DAILY_USD - daily_spent))
