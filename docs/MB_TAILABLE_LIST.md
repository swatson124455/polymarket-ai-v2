<!-- SNAPSHOT (docs copy). Generated 2026-09-09T01:17:43Z by the DEPLOYED
clone (master 3602f573) run as polymarket against the LIVE boards regenerated
01:15Z on the merged code (fill-modeled firehose rows; $algo at the sizer
foursome bankroll 500 / kelly 0.25 / conc floor 1 / min_viable 1; allocator
tiers OFF). The cron regenerates the live copy daily at stage 11. EVERY $ IS
HYPOTHETICAL; forward columns fill after the first 11:40Z run of the 12-stage
chain. -->

# MB TAILABLE LIST - verified tailable traders (generated; do not hand-edit)

**Generated:** 2026-09-09T01:17:43Z by `scripts/mb_tailable_list.py` @ 3602f57 | **EVERY $ IS HYPOTHETICAL** (no real order exists; real money only via docs/MB_GO_CHECKLIST.md).
...
| shadow_sink | 2026-09-09T01:16:20Z | 98 |
| dossiers | 2026-09-08T19:26:55Z | 153 |
| eligibility_cache | 2026-09-09T01:17:40Z | 13 |
...
- Candidate universe: 12 wallets = post-conversion roster groups U pipeline dossiers U board QUALIFIES with $ref100/wk LCB>0 (firehose 19236 rows, roster 98 rows)
...
| 2 | `0xe48217d0b7` | +8 | +0.74 / +3.30 | +456 | +52.98 / +222.89 | +0.530 | 11 | 17/16 | 98 | PASS | ADMIT | no p=0.19 | cohort5 | not registered | - | - |
| 3 | `0x75a27d0cc9` | +1 | +0.02 / +0.06 | +87 | +10.89 / +406.27 | +0.109 | 10 | 19/19 | 74 | PASS | ADMIT | untested | cohort8 | not registered | - | 2026-09-09T00:40 |
| 4 | `0xe9f5c75ee1` | +1 | +0.02 / +0.13 | +123 | +7.60 / +81.36 | +0.076 | 20 | 18/18 | 91 | PASS | ADMIT | untested | cohort8 | not registered | - | 2026-09-09T00:17 |
| 5 | `0x2c50852938` | +0 | +0.00 / +0.00 | +667 | +94.72 / +834.93 | +0.947 | 8 | 11/9 | 81 | PASS | ADMIT | no p=0.47 | cohort5 | not registered | - | 2026-09-08T08:36 |
...
| 3 | `0x4ab40f2a49` | +143 | +9.53 / +21.66 | +5,671 | +495.24 / +1912.32 | +4.952 | 13 | 8/8 | 97 | PASS | INSUFF | untested | no | not registered | - | - |
| 4 | `0x4f453abb65` | +15 | +0.56 / +2.93 | +132 | +17.75 / +178.70 | +0.178 | 9 | 6/6 | 84 | PASS | INSUFF | untested | no | not registered | - | - |
| 5 | `0x1c010e69db` | +0 | +0.00 / +0.00 | +48 | +0.67 / +120.90 | +0.007 | 88 | 10/8 | 97 | PASS | INSUFF | untested | no | not registered | - | - |
| 6 | `0x5d2e0736fb` | +0 | -0.00 / +0.00 | -98 | -12.46 / +789.02 | -0.125 | 9 | 11/11 | 78 | PASS | INSUFF | untested | no | not registered | - | - |
| 7 | `0xf7d03961dd` | +0 | -0.00 / +0.00 | -318 | -16.27 / +35.73 | -0.163 | 24 | 19/20 | 94 | PASS | INSUFF | untested | no | not registered | - | - |
