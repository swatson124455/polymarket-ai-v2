...
**Status:** IMPLEMENTED `8c778d3` (2026-07-08, same session) — all four workstreams shipped; migration 079 must be applied on the VPS (code detects the column and falls back with a warning until then). Scopes fallacy-audit findings **V1, V4, V6, V10,
