...
| 5 | AMEND_DECREASE | **VERIFIED LIVE 2026-08-25T20:21Z** (supervised, operator-approved): 2ct post-only NO@0.01 on T5.44, amend 2->1 returned SAME order_id + remaining_count 1.00 (queue preserved), clean cancel, 0 fills, $0 cost | (moot) | (moot) | RESOLVED: endpoint works as designed -> KEEP; arming stays a separate operator call |
