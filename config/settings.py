...
class Settings(BaseSettings):
    ...
    RISK_MAX_TOTAL_EXPOSURE_USD: float = float(os.getenv("RISK_MAX_TOTAL_EXPOSURE_USD", "10000"))
    ...
    MIRROR_MAX_CONCURRENT_POSITIONS: int = int(os.getenv("MIRROR_MAX_CONCURRENT_POSITIONS", "20"))
