#!/usr/bin/env python3
# HAZARD (S8 review, 2026-09-01): this probe imports the ARCHIVED
# py_clob_client (not _v2) and posts GTC WITHOUT post_only — exactly the SDK
# and order shape the engine bans. NEVER copy order code from this file into
# anything on the money path. Engine-blessed pattern: py_clob_client_v2 +
# post_only=True (maker_live_engine.py ExecCore._submit_live).
